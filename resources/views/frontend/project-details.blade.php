		...
		<div class="mry-banner mry-p-140-0">
			<div class="container">
				<div class="mry-main-title mry-title-center">
					...
					<h1 class="mry-mb-20 mry-fo">Works Details</h1>
					<div class="mry-text mry-fo">Catgory: {{ $project_details_data->service_cat }}</div>
				...
				<div class="row justify-content-center">
					...
					<div class="col-lg-8">
						...
						<div class="mry-mb-100 mry-text-center">
							...
							<h3 class="mry-mb-40 mry-fo">{{ $project_details_data->service_title }}</h3>
							<p class="text-justify mry-text mry-fo">{{ $project_details_data->service_short_desc }}</p>
						</div>
					...
					<div class="col-lg-12">
						...
						<div class="mry-portfolio-frame">
							<div class="mry-masonry-grid mry-without-descr mry-p-0-100">
								...
								@foreach($project_details_data->images as $img)
									@if($loop->odd)
									<div class="mry-masonry-grid-item mry-masonry-grid-item-50 interior">
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													<img src="{{ url('upload/gallery/'.$img->image) }}" alt="project" >
													<div class="mry-cover-overlay"></div>
												<div class="mry-hover-links">
													<a href="{{ url('upload/gallery/'.$img->image) }}" data-fancybox="works" class="mry-zoom mry-magnetic-link"><span class="mry-magnetic-object"><i
