		...
		<div class="row">
			<div class="col-xl-8 d-flex offset-1">
				<div class="card flex-fill">
					...
					<div class="card-body">
						<form action="{{ url('admin/contact/update-contact/'.$contact_data->id) }}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input type="text" value="{{ $contact_data->first_name }}" class="form-control" name="first_name" required>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">Last Name</label>
								<div class="col-lg-9">
									<input type="text" value="{{ $contact_data->last_name }}" class="form-control" name="last_name" required>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">Email</label>
								<div class="col-lg-9">
									<input type="email" value="{{ $contact_data->email }}" class="form-control" name="email" required>
								</div>
							</div>
							<div class="form-group row">
