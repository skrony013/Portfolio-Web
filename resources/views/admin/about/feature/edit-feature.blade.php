		...
		<div class="row">
			<div class="col-xl-8 d-flex offset-1">
				<div class="card flex-fill">
					...
					<div class="card-body">
						<form action="{{ url('admin/about/features/update-feature/'.$feature_data->id )}}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input type="text" value="{{ $feature_data->feature_heading }}" class="form-control" name="feature_heading" required>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">Feature Title</label>
								<div class="col-lg-9">
									<input type="text" value="{{ $feature_data->feature_title }}" class="form-control" name="feature_title" required>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">Feature Description</label>
								<div class="col-lg-9">
									<textarea name="feature_desc" class="form-control" id="" cols="10" rows="5">{{ $feature_data->feature_desc }}</textarea>
								</div>
							</div>
