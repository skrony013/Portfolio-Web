		...
		<div class="row">
			<div class="col-xl-8 d-flex offset-1">
				<div class="card flex-fill">
					...
					<div class="card-body">
						<form action="{{ url('admin/sliders/update-slider/'.$slider->id) }}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input type="text" class="form-control" value="{{ $slider->title_starting }}" name="title_starting">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">Title Ending</label>
								<div class="col-lg-9">
									<input type="text" class="form-control" value="{{ $slider->title_ending }}" name="title_ending">
								</div>
							</div>
							<div class="form-group row">
